...
function QuestionCard(props) {
  return (
    <div className="questionCard">
      ...
      {props.choiceC === undefined ? <div> </div> : <div className="choiceCandDdiv"><button disabled={props.choiceAorBorCorDClicked} onClick={props.choiceCClicked} className="choiceButton">{props.choiceC}</button>
      <button disabled={props.choiceAorBorCorDClicked} onClick={props.choiceDClicked} className="choiceButton">{props.choiceD}</button></div>}</div>
